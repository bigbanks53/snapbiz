...
export default function IdeaHero() {
  ...
  return (
    <section id="idea-hero" className="relative overflow-hidden bg-forest">
      ...
      <div className="relative mx-auto max-w-4xl px-5 pb-24 pt-32 text-center sm:px-8 sm:pt-40 lg:pb-32">
        {/* Eyebrow */}
        <motion.div
          {...rise(0.15)}
        ...
        <motion.p
          {...rise(0.75)}
          className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-ivory/70 sm:text-lg"
        >
        ...
        <motion.div
          {...rise(0.9)}
          className="mx-auto mt-12 max-w-2xl rounded-[1.75rem] border border-ivory/15 bg-forest-deep/80 p-5 text-left shadow-card backdrop-blur-md sm:p-7"
        >
